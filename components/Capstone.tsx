        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <div className="flex items-center space-x-6 justify-center lg:justify-start">
              ...
              <a href={CAPSTONE_PROJECT.githubUrl} target="_blank" rel="noopener noreferrer" className="flex items-center font-semibold text-gray-300 hover:text-blue-400 transition-colors duration-300">
